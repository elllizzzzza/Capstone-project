...
@Component
public class ProgressMapper implements Mapper<Progress, ProgressDTO> {

    @Override
    public ProgressDTO mapToDTO(Progress entity, ProgressDTO dto) {
    ...
    @Override
    public Progress mapToEntity(ProgressDTO dto, Progress entity) {
